<template>
  ...
  <textarea v-model="commentText" class="form-control mb-3" rows="4" placeholder="Write your comment here..."></textarea>
...
async function submitComment() {
  ...
  try {
    // استبدل URL ده بالرابط اللي هيرسل له البيانات في الباك إند
    ...
    commentText.value = ''; // امسح نص التعليق بعد الإرسال
  } catch (error) {
